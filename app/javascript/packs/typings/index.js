    ...
    document.addEventListener('keyup', () => {
      if (isPlayEnd === true) {
        ...
        if (time <= 0) {
          ...
          const url = `https://twitter.com/share?&url=https://surf-typing.herokuapp.com/&text=60秒間で正タイプ数${count}文字、誤タイプ数${missCount}文字でした。あなたに贈る言葉：『${wordJp}』&hashtags=海,タイピングゲーム,サーフィン,ギター,前向き,SurfTyping&lang=ja`;
